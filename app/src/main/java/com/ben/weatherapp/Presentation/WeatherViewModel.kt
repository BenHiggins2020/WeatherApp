...
import com.ben.weatherapp.Data.Repository.WeatherRepository
    ...
    fun loadWeatherInfo(){
        viewModelScope.launch {
            ...
            locationTracker.getCurrentLocation()?.let {location ->
                Log.d("WeatherViewModel"," getCurrentLocation = ${location.latitude} ${location.longitude}")
                ...
                state = state.copy(
                    isLoading = false,
                    error = "Couldn't retrieve location. Make sure to grant permissions! "
                )
            }
        }
    }
